...
import { LayoutDashboard, BookOpen, Pill, Settings as SettingsIcon, Droplets, Search, UtensilsCrossed, Stethoscope, FlaskConical } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/dialysis-log', label: '透析', icon: <Stethoscope className="h-5 w-5" /> },
  { to: '/lab-report', label: '化验', icon: <FlaskConical className="h-5 w-5" /> },
