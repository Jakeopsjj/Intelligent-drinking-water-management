...
import { LayoutDashboard, BookOpen, Citrus, Pill, Settings as SettingsIcon, Droplets, Search, Apple } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/diet', label: '饮食', icon: <Apple className="h-5 w-5" /> },
